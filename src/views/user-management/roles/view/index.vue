...
import { deleteRoleItem, getRoleItem, getRoleItemLabel } from '@/api/roles';
import Container from '@/components/container.vue';
import PageHeader from '@/components/page-header.vue';
import useLoading from '@/hooks/loading';
import { RoleProfile } from '@/store/modules/user/types';
...
const userInfo = ref<RoleProfile>({});
...
const fetchData = async () => {
  try {
    ...
    const { data: labels } = await getRoleItemLabel(Number(route.params.id))
