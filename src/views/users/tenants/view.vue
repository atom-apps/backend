<template>
  <div>
    <PageHeader title="用户管理" subtitle="租户详情" :back="true" :loading="loading">
      <a-button type="primary" @click="$router.push({ name: 'TenantEdit', params: { id: route.params.id } })">编辑</a-button>
