<template>
  <div>
    <PageHeader subtitle="用户管理" :back="true" :loading="loading">
      <a-button v-can="'UserEdit'" type="primary" @click="$router.push({ name: 'UserEdit', params: { id: route.params.id } })">编辑</a-button>

      <a-popconfirm v-can="'UserDelete'" content="确认删除？" type="warning" :ok-loading="deleting" @ok="handleConfirmDelete" position="lt">
