<template>
  <div>
    <PageHeader subtitle="内容管理" :back="true" :loading="loading">
      <a-button v-can="'ArticleEdit'" type="primary" @click="$router.push({ name: 'ArticleEdit', params: { id: route.params.id } })">编辑</a-button>

      <a-popconfirm v-can="'ArticleDelete'" content="确认删除？" type="warning" :ok-loading="deleting" @ok="handleConfirmDelete" position="lt">
...
import { ArticleItem, deleteArticleItem, getArticleItem, tableArticleLabels } from '@/api/posts/articles';
