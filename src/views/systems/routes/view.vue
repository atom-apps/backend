<template>
  <div>
    <PageHeader title="系统管理" subtitle="路由详情" :back="true" :loading="loading">
      <a-button type="primary" @click="$router.push({ name: 'RouteEdit', params: { id: route.params.id } })">编辑</a-button>
